...
`;function yt(t,e){return Math.abs(t)>=e?`${(t/1e3).toFixed(1)} kW`:`${Math.round(t)} W`}function mt(t){if(null==t)return 0;const e="number"==typeof t?t:parseFloat(t);return isNaN(e)?0:e}function _t(t){const{solar:e,battery:i,load:r,gridCombined:o}=t,s=void 0!==t.gridImport?Math.max(0,t.gridImport):o>0?o:0,a=e>0?void 0!==t.gridExport?Math.max(0,t.gridExport):o<0?Math.abs(o):0:0;return{solarToHome:e>0?Math.min(e,r):0,solarToBattery:i>0&&e>0?Math.min(i,e):0,solarToGrid:a,gridToHome:s,batteryToHome:i<0?Math.abs(i):0,gridToBattery:void 0!==t.gridToBattery?Math.max(0,t.gridToBattery):void 0!==t.gridBatteryCombined&&t.gridBatteryCombined>0?t.gridBatteryCombined:0,batteryToGrid:void 0!==t.batteryToGrid?Math.max(0,t.batteryToGrid):void 0!==t.gridBatteryCombined&&t.gridBatteryCombined<0?Math.abs(t.gridBatteryCombined):0}}function bt(t,e){const i=t.toLowerCase();return i.includes("solar")||i.includes("pv")?e>0?"Generating":"Idle":i.includes("battery")||i.includes("batt")?e>0?"Charging":e<0?"Discharging":"Idle":i.includes("grid")?e>0?"Importing":e<0?"Exporting":"Idle":i.includes("load")||i.includes("home")||i.includes("consumption")?e>0?"Consuming":"Idle":e>0?"Active":"Idle"}const $t=300,xt=150,wt=150,kt=xt,Ht=wt,St=250,At=wt,Et=xt,Ct=250,Pt=32,Mt=17;let Tt=class extends dt{constructor(){super(...arguments),this.solar=0,this.battery=0,this.grid=0,this.load=0,this.socPercent=0,this.wattThreshold=1e3,this.solarName="Solar",this.gridName="Grid",this.homeName="Home",this.batteryName="Battery",this.flows={solarToHome:0,solarToBattery:0,solarToGrid:0,gridToHome:0,batteryToHome:0,gridToBattery:0,batteryToGrid:0},this.diagramDevices=[]}_batteryColor(){const t=Math.max(0,Math.min(100,this.socPercent));let e,i,r;if(t>=50){const o=(t-50)/50;e=Math.round(16+229*o),i=Math.round(185+-27*o),r=Math.round(129+-118*o)}else{const o=t/50;e=Math.round(239+6*o),i=Math.round(68+90*o),r=Math.round(68+-57*o)}return`rgb(${e},${i},${r})`}_lineWidth(t){return t<=0?2:Math.min(8,Math.max(2,t/1e3*4+2))}_trim(t,e,i,r,o=36){const s=i-t,a=r-e,n=Math.sqrt(s*s+a*a);return 0===n?{x1:t,y1:e,x2:i,y2:r}:{x1:t+s/n*o,y1:e+a/n*o,x2:i-s/n*o,y2:r-a/n*o}}_flowLine(t,e,i,r,o,s,a=!1,n=36,l=36){const d=o>1,{x1:c,y1:h,x2:p,y2:v}=this._trim(t,e,i,r,Math.min(n,l)),g=this._lineWidth(o),u=d?a?"flow-active-rev":"flow-active":"";return j`
      <line
        ...
        class="${u}"
      />
    `}_deviceLine(t,e,i,r){const o=i>5,{x1:s,y1:a,x2:n,y2:l}=this._trim(St,At,t,e,35),d=n-s,c=l-a,h=Math.sqrt(d*d+c*c);return j`
      <line
    ...
    `}render(){var t;const e=this.flows,i=this._batteryColor(),r=i.replace("rgb(","rgba(").replace(")",", 0.15)"),o=null!==(t=this.diagramDevices)&&void 0!==t?t:[],s=o.length,a=s>0,n=52*(s-1),l=At-n/2,d=o.map((t,e)=>({d:t,x:332,y:l+52*e})),c=a?460:$t,h=a?Math.min(0,l-Mt-20):0,p=a?Math.max(320,l+n+Mt+35):320;return F`
      <svg
        viewBox="${`0 ${h} ${c} ${p-h}`}"
      ...
      >
        ...
        <!-- Solar → Home -->
        ${this._flowLine(kt,50,St,At,e.solarToHome,"#f59e0b")}
        <!-- Solar → Battery -->
        ${this._flowLine(kt,50,Et,Ct,e.solarToBattery,"#f59e0b")}
        <!-- Solar → Grid (export) -->
        ${this._flowLine(kt,50,50,Ht,e.solarToGrid,"#f59e0b")}
        <!-- Grid → Home (import) -->
        ${this._flowLine(50,Ht,St,At,e.gridToHome,"#8b5cf6")}
        <!-- Battery → Home (discharge) -->
        ${this._flowLine(Et,Ct,St,At,e.batteryToHome,i)}
        ...
        ${this._node(St,At,"M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z",this.homeName,this.load,"#3b82f6","rgba(59,130,246,0.15)")}
        ${this._node(Et,Ct,"M16,20H8V6H16M16.67,4H15V2H9V4H7.33A1.33,1.33 0 0,0 6,5.33V20.67C6,21.4 6.6,22 7.33,22H16.67A1.33,1.33 0 0,0 18,20.67V5.33C18,4.6 17.4,4 16.67,4Z",this.batteryName,this.battery,i,r)}
  ...
  `,t([gt({type:Array})],Nt.prototype,"devices",void 0),t([gt({type:Number})],Nt.prototype,"wattThreshold",void 0),Nt=t([ht("device-row")],Nt);const Lt=[{key:"solar",enabled:!0},{key:"battery",enabled:!0},{key:"grid",enabled:!0},{key:"load",enabled:!0}];let Dt=class extends dt{constructor(){super(...arguments),this._solar=0,this._battery=0,this._grid=0,this._load=0,this._soc=0,this._solarExport=0,this._gridToBattery=0,this._flows={solarToHome:0,solarToBattery:0,solarToGrid:0,gridToHome:0,batteryToHome:0,gridToBattery:0,batteryToGrid:0},this._sparklines={},this._error=null,this._lastSparklineFetch=0,this._sparklineDebounceMs=3e5}get hass(){return this._hass}static getStubConfig(){return{solar:{entity:"sensor.solar_power"},battery:{entity:"sensor.battery_power",soc_entity:"sensor.battery_soc"},grid:{entity:"sensor.grid_power"},load:{entity:"sensor.load_power"}}}static getConfigElement(){return document.createElement("solar-overview-card-editor")}setConfig(t){var e,i,r;if(!(null===(e=t.solar)||void 0===e?void 0:e.entity))throw new Error('solar-overview-card: "solar.entity" required');if(!(null===(i=t.battery)||void 0===i?void 0:i.entity))throw new Error('solar-overview-card: "battery.entity" required');if(!(null===(r=t.load)||void 0===r?void 0:r.entity))throw new Error('solar-overview-card: "load.entity" required');const o=t.grid;if(!(null==o?void 0:o.entity)&&!(null==o?void 0:o.import_entity)&&!(null==o?void 0:o.export_entity))throw new Error("solar-overview-card: at least one grid entity required");this._config={watt_threshold:1e3,show_sparklines:!0,theme:"auto",show_flow:!0,show_stats:!0,show_devices:!0,...t},this._error=null}getCardSize(){return 4}set hass(t){if(this._hass=t,this._config)try{const t=this._config.grid,e=this._readEntity(this._config.solar.entity),i=this._readEntity(this._config.battery.entity),r=this._readEntity(this._config.load.entity),o=t.entity?this._readEntity(t.entity):0;this._solar=this._config.solar.invert?-e:e,this._battery=this._config.battery.invert?-i:i,this._grid=t.invert?-o:o,this._load=this._config.load.invert?-r:r,this._config.battery.soc_entity&&(this._soc=this._readEntity(this._config.battery.soc_entity));const s=t.import_entity?this._readEntity(t.import_entity):void 0,a=t.export_entity?this._readEntity(t.export_entity):this._config.solar.export_entity?this._readEntity(this._config.solar.export_entity):void 0,n=t.to_battery_entity?this._readEntity(t.to_battery_entity):this._config.battery.grid_charge_entity?this._readEntity(this._config.battery.grid_charge_entity):void 0,l=t.from_battery_entity?this._readEntity(t.from_battery_entity):void 0,d=t.battery_entity?this._readEntity(t.battery_entity):void 0;this._flows=_t({solar:this._solar,battery:this._battery,load:this._load,gridCombined:this._grid,gridImport:s,gridExport:a,gridToBattery:n,batteryToGrid:l,gridBatteryCombined:d});const c=Date.now();!1!==this._config.show_sparklines&&c-this._lastSparklineFetch>this._sparklineDebounceMs&&(this._lastSparklineFetch=c,this._fetchSparklines())}catch(t){this._error=t.message}}_readEntity(t){var e;if(!(null===(e=this._hass)||void 0===e?void 0:e.states))return 0;const i=this._hass.states[t];return i?mt(i.state):0}async _fetchSparklines(){var t,e,i;if(!this._config||!(null===(t=this._hass)||void 0===t?void 0:t.callApi))return;const r=[this._config.solar.entity,this._config.battery.entity,null!==(e=this._config.grid.entity)&&void 0!==e?e:this._config.grid.import_entity,this._config.load.entity].filter(t=>!!t),o=new Date,s=null!==(i=this._config.sparkline_hours)&&void 0!==i?i:2,a=new Date(o.getTime()-60*s*60*1e3).toISOString(),n={};await Promise.allSettled(r.map(async t=>{try{const e=`history/period/${a}?filter_entity_id=${t}&minimal_response=true&no_attributes=true`,i=await this._hass.callApi("GET",e);if(!Array.isArray(i)||0===i.length)return;n[t]=i[0].map(t=>{const e=mt(t.state);return isNaN(e)?null:{time:new Date(t.last_updated).getTime(),value:e}}).filter(t=>null!==t)}catch{}})),this._sparklines={...this._sparklines,...n}}_threshold(){var t,e;return null!==(e=null===(t=this._config)||void 0===t?void 0:t.watt_threshold)&&void 0!==e?e:1e3}_deviceItems(){var t,e;return(null===(t=this._config)||void 0===t?void 0:t.devices)&&(null===(e=this._hass)||void 0===e?void 0:e.states)?this._config.devices.map(t=>{var e,i;return{entityId:t.entity,name:null!==(e=t.name)&&void 0!==e?e:t.entity,icon:null!==(i=t.icon)&&void 0!==i?i:"M7,2V13H10V22L17,10H13L17,2H7Z",watts:this._readEntity(t.entity),color:t.color}}):[]}_diagramDevices(){var t,e;return(null===(t=this._config)||void 0===t?void 0:t.devices)&&(null===(e=this._hass)||void 0===e?void 0:e.states)?this._config.devices.filter(t=>t.show_on_diagram).map(t=>{var e,i;return{name:null!==(e=t.name)&&void 0!==e?e:t.entity,watts:this._readEntity(t.entity),color:null!==(i=t.color)&&void 0!==i?i:"#6366f1"}}):[]}_panelProps(t,e,i,r,o,s){var a,n,l;const d=this._threshold(),c=this._config[t];return{entityId:s,name:null!==(a=null==c?void 0:c.name)&&void 0!==a?a:i,icon:r,value:e,displayValue:yt(e,d),stateLabel:bt(s,e),stateColor:o,showSparkline:!1!==(null===(n=this._config)||void 0===n?void 0:n.show_sparklines),sparklineHistory:null!==(l=this._sparklines[s])&&void 0!==l?l:[],panelClass:`panel--${t}`,badgeClass:`badge--${t}`}}render(){var t,e,i,r,o,s,a,n;if(!this._config)return F`<ha-card><div class="error-card">solar-overview-card: no config.</div></ha-card>`;if(this._error)return F`<ha-card><div class="error-card">Error: ${this._error}</div></ha-card>`;const l=this._threshold(),d=!1!==this._config.show_flow,c=!1!==this._config.show_stats,h=!1!==this._config.show_devices,p=this._panelProps("solar",this._solar,"Solar","M4,2H20A2,2 0 0,1 22,4V20A2,2 0 0,1 20,22H4A2,2 0 0,1 2,20V4A2,2 0 0,1 4,2M4,4V20H20V4H4M5,5H11V11H5V5M13,5H19V11H13V5M5,13H11V19H5V13M13,13H19V19H13V13Z","#f59e0b",this._config.solar.entity),v=this._panelProps("battery",this._battery,"Battery","M16,20H8V6H16M16.67,4H15V2H9V4H7.33A1.33,1.33 0 0,0 6,5.33V20.67C6,21.4 6.6,22 7.33,22H16.67A1.33,1.33 0 0,0 18,20.67V5.33C18,4.6 17.4,4 16.67,4Z","#10b981",this._config.battery.entity),g=this._panelProps("grid",this._grid,"Grid","M11.5,3.5L10.5,6H13.5L12.5,3.5H11.5M10,7L8.5,10H15.5L14,7H10M8,11L5,17H8L9,14H15L16,17H19L16,11H8M8,18L11,21H13L16,18H8Z","#8b5cf6",null!==(e=null!==(t=this._config.grid.entity)&&void 0!==t?t:this._config.grid.import_entity)&&void 0!==e?e:""),u=this._flows.batteryToHome+this._flows.gridToHome,f=this._panelProps("load",u,"Home","M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z","#3b82f6",this._config.load.entity),y=this._deviceItems();return F`
      <ha-card>
        <div class="card" theme="${null!==(i=this._config.theme)&&void 0!==i?i:"auto"}">
          ...
          ${d?F`
            <div class="flow-diagram">
              <flow-diagram
                ...
                .gridName="${null!==(o=this._config.grid.name)&&void 0!==o?o:"Grid"}"
                .homeName="${null!==(s=this._config.load.name)&&void 0!==s?s:"Home"}"
                .batteryName="${null!==(a=this._config.battery.name)&&void 0!==a?a:"Battery"}"
              ></flow-diagram>
            </div>
          `:""}
          ...
          ${c?F`
            <div class="stat-grid">
              ${(null!==(n=this._config.panels)&&void 0!==n?n:Lt).filter(t=>!1!==t.enabled).map(({key:t})=>{const e={solar:p,battery:v,grid:g,load:f}[t];return F`
                    <stat-panel
                      .entityId="${e.entityId}"
                      .name="${e.name}"
                      .icon="${e.icon}"
          ...
          ${h&&this._config.devices&&this._config.devices.length>0?F`
    ...
    `}_entityField(t,e,i,r){var o,s;return F`
      <div class="field-wrap">
        ...
        ${void 0!==(null==r?void 0:r.namePath)?F`
          <div class="field-row" style="margin-top:4px;">
            <ha-selector
              .label="Display name"
              .selector=${{text:{}}}
              .value="${null!==(o=r.nameValue)&&void 0!==o?o:""}"
              @value-changed="${t=>{var e;return this._setValue(r.namePath,null!==(e=t.detail.value)&&void 0!==e?e:"")}}"
            ></ha-selector>
            ${r.nameValue?F`
              <button class="clear-btn" title="Clear" @click="${()=>this._setValue(r.namePath,"")}">✕</button>
            `:""}
          </div>
        `:""}
        ${(null==r?void 0:r.hint)?F`<p class="hint" style="margin:3px 0 0;">${r.hint}</p>`:""}
        ${void 0!==(null==r?void 0:r.invertPath)?this._boolField("Invert sign (flip +/−)",r.invertPath,null!==(s=r.invertValue)&&void 0!==s&&s):""}
      </div>
    ...
    `}_renderMain(){var t,e,i,r,o,s,a,n,l,d,c,h,p;if(!this._config)return F``;const v=this._config,g=null!==(e=null===(t=v.devices)||void 0===t?void 0:t.length)&&void 0!==e?e:0,u=(t,e,i,r,o)=>F`
    ...
    `,f=(null!==(i=v.panels)&&void 0!==i?i:Lt).filter(t=>!1!==t.enabled).length;return F`
      <div class="nav-list">
        ...
        ${u("solar","☀️","Solar",null!==(o=null===(r=v.solar)||void 0===r?void 0:r.entity)&&void 0!==o?o:"Not configured","rgba(245,158,11,0.18)")}
    ...
    `}_renderHousePage(){var t;if(!this._config)return F``;const e=this._config.load,i=this._computeCurrentFlows(),r=null!==(t=this._config.watt_threshold)&&void 0!==t?t:1e3,o=t=>yt(t,r);return F`
    ...
    `}_renderPanelsPage(){var t;if(!this._config)return F``;const e=null!==(t=this._config.panels)&&void 0!==t?t:Lt,i={solar:{icon:"☀️",label:"Solar"},battery:{icon:"🔋",label:"Battery"},grid:{icon:"⚡",label:"Grid"},load:{icon:"🏠",label:"House"}};return F`
      ...
      <div class="form-col">
        ${e.map((t,r)=>{const o=i[t.key];return F`
            <div class="panel-item">
              <div class="panel-move">
                <button class="move-btn" ?disabled="${0===r}"
                  @click="${()=>this._movePanel(r,-1)}">▲</button>
                <button class="move-btn" ?disabled="${r===e.length-1}"
                  @click="${()=>this._movePanel(r,1)}">▼</button>
              </div>
              <span style="font-size:1.1rem;">${o.icon}</span>
              <span class="panel-label">${o.label}</span>
              <ha-selector
                .selector=${{boolean:{}}}
                .value="${t.enabled}"
                @value-changed="${t=>this._togglePanel(r,t.detail.value)}"
              ></ha-selector>
            </div>
          `})}
        <p class="hint">Toggle panels on/off and reorder with ▲▼ arrows.</p>
      </div>
    `}_setPanels(t){this._config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config,panels:t}}}))}_togglePanel(t,e){var i,r;const o=[...null!==(r=null===(i=this._config)||void 0===i?void 0:i.panels)&&void 0!==r?r:Lt];o[t]={...o[t],enabled:e},this._setPanels(o)}_movePanel(t,e){var i,r;const o=[...null!==(r=null===(i=this._config)||void 0===i?void 0:i.panels)&&void 0!==r?r:Lt],s=t+e;s<0||s>=o.length||([o[t],o[s]]=[o[s],o[t]],this._setPanels(o))}_startEdit(t){var e,i,r,o;const s=this._config.devices[t];this._editingDevice={entity:s.entity,name:null!==(e=s.name)&&void 0!==e?e:"",icon:null!==(i=s.icon)&&void 0!==i?i:"",color:null!==(r=s.color)&&void 0!==r?r:"#6366f1",show_on_diagram:null!==(o=s.show_on_diagram)&&void 0!==o&&o},this._editingIndex=t}_saveEdit(){var t;if(null===this._editingIndex||!this._config)return;const e=[...null!==(t=this._config.devices)&&void 0!==t?t:[]];e[this._editingIndex]={...this._editingDevice},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config,devices:e}}})),this._editingIndex=null}_cancelEdit(){this._editingIndex=null}_deleteDevice(t){var e;if(!this._config)return;const i=[...null!==(e=this._config.devices)&&void 0!==e?e:[]];i.splice(t,1),this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config,devices:i}}}))}_addDevice(){var t;if(!this._config||!this._newDevice.entity)return;const e=[...null!==(t=this._config.devices)&&void 0!==t?t:[],{...this._newDevice}];this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config,devices:e}}})),this._newDevice={entity:"",name:"",icon:"mdi:power-socket",color:"#6366f1",show_on_diagram:!1}}_deviceForm(t,e,i,r,o){return F`
