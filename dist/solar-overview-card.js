 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function gt(t){return vt({...t,state:!0,attribute:!1})}const yt=a`
  /* ─── Colour tokens ───────────────────────────────────────────── */
  :host {
    --color-solar:   #f59e0b;
...
`;function _t(t,e){return Math.abs(t)>=e?`${(t/1e3).toFixed(1)} kW`:`${Math.round(t)} W`}function ft(t,e){const i=mt(t);return"kW"===e?1e3*i:"MW"===e?1e6*i:i}function mt(t){if(null==t)return 0;const e="number"==typeof t?t:parseFloat(t);return isNaN(e)?0:e}function bt(t){const{solar:e,battery:i,load:o,gridCombined:r}=t,s=e>0?void 0!==t.gridExport?Math.max(0,t.gridExport):r<0?Math.abs(r):0:0,a=i>0&&e>0?Math.min(i,e):0,n=void 0!==t.gridToBattery?Math.max(0,t.gridToBattery):void 0!==t.gridBatteryCombined&&t.gridBatteryCombined>0?t.gridBatteryCombined:i>0?Math.max(0,i-a):0,l=void 0!==t.gridImport?Math.max(0,t.gridImport):r>0?Math.max(0,r-n):0;return{solarToHome:e>0?o>0?Math.min(e,o):Math.max(0,e-s-a):0,solarToBattery:a,solarToGrid:s,gridToHome:l,batteryToHome:i<0?Math.abs(i):0,gridToBattery:n,batteryToGrid:void 0!==t.batteryToGrid?Math.max(0,t.batteryToGrid):void 0!==t.gridBatteryCombined&&t.gridBatteryCombined<0?Math.abs(t.gridBatteryCombined):0}}function $t(t,e){switch(t){case"solar":return e>0?"Generating":"Idle";case"battery":return e>0?"Charging":e<0?"Discharging":"Idle";case"grid":return e>0?"Importing":e<0?"Exporting":"Idle";case"load":return e>0?"Consuming":"Idle";default:return e>0?"Active":"Idle"}}function xt(t,e){var i,o;const r=t.grid,s="discharging"===t.battery.positive_means||!0===t.battery.invert,a="exporting"===r.positive_means||!0===r.invert,n=e(t.solar.entity)*(t.solar.invert?-1:1),l=e(t.battery.entity)*(s?-1:1),d=e(null===(i=t.load)||void 0===i?void 0:i.entity)*((null===(o=t.load)||void 0===o?void 0:o.invert)?-1:1),c=r.entity?e(r.entity)*(a?-1:1):0,h=r.export_entity?e(r.export_entity):t.solar.export_entity?e(t.solar.export_entity):void 0,p=r.to_battery_entity?e(r.to_battery_entity):t.battery.grid_charge_entity?e(t.battery.grid_charge_entity):void 0;return{solar:n,battery:l,grid:c,load:d,flowParams:{solar:n,battery:l,load:d,gridCombined:c,gridImport:r.import_entity?e(r.import_entity):void 0,gridExport:h,gridToBattery:p,batteryToGrid:r.from_battery_entity?e(r.from_battery_entity):void 0,gridBatteryCombined:r.battery_entity?e(r.battery_entity):void 0}}}const wt="M7,2V13H10V22L17,10H13L17,2H7Z",St=17;let kt=class extends dt{constructor(){super(...arguments),this.solar=0,this.battery=0,this.grid=0,this.load=0,this.socPercent=0,this.wattThreshold=1e3,this.solarName="Solar",this.gridName="Grid",this.homeName="Home",this.batteryName="Battery",this.solarSecondary="",this.gridSecondary="",this.homeSecondary="",this.batterySecondary="",this.flows={solarToHome:0,solarToBattery:0,solarToGrid:0,gridToHome:0,batteryToHome:0,gridToBattery:0,batteryToGrid:0},this.diagramDevices=[],this.backgroundImage="",this.editMode=!1,this.textColor="#ffffff",this.nodeStyle="circle",this.showFlowLines=!0,this.nodeIconSize=18,this.nodeSize=32,this.nodeTextSize=11,this.solarColor="",this.gridColor="",this.homeColor="",this.batteryNodeColor="",this._pos={solar:{x:150,y:50},grid:{x:50,y:150},home:{x:250,y:150},battery:{x:150,y:250}},this._dragging=null,this._dragStartClient={x:0,y:0},this._dragStartPos={x:0,y:0}}willUpdate(t){var e,i,o,r,s;if(t.has("nodePositions")){const t=null!==(e=this.nodePositions)&&void 0!==e?e:{};this._pos={solar:{x:150,y:50,...null!==(i=t.solar)&&void 0!==i?i:{}},grid:{x:50,y:150,...null!==(o=t.grid)&&void 0!==o?o:{}},home:{x:250,y:150,...null!==(r=t.home)&&void 0!==r?r:{}},battery:{x:150,y:250,...null!==(s=t.battery)&&void 0!==s?s:{}}}}}_onNodePointerDown(t,e){this.editMode&&(t.preventDefault(),t.stopPropagation(),this._dragging=e,this._dragStartClient={x:t.clientX,y:t.clientY},this._dragStartPos={...this._pos[e]},t.currentTarget.setPointerCapture(t.pointerId))}_onPointerMove(t){if(!this._dragging)return;const e=this.shadowRoot.querySelector("svg").getScreenCTM();if(!e)return;const i=(t.clientX-this._dragStartClient.x)/e.a,o=(t.clientY-this._dragStartClient.y)/e.d;this._pos={...this._pos,[this._dragging]:{x:Math.round(this._dragStartPos.x+i),y:Math.round(this._dragStartPos.y+o)}}}_onPointerUp(){this._dragging&&(this._dragging=null,this.dispatchEvent(new CustomEvent("nodes-moved",{detail:{positions:{...this._pos}},bubbles:!0,composed:!0})))}get _scale(){return this.nodeSize/32}get _nodeR(){return this.nodeSize}get _cardW(){return 82*this._scale}get _cardH(){return 46*this._scale}get _cardHalf(){return this._cardH/2}get _cardR(){return 10*this._scale}get _textScale(){return this.nodeTextSize/11}get _fsValue(){return this.nodeTextSize}get _fsLabel(){return this.nodeTextSize-1}get _fsSecondary(){return this.nodeTextSize-2}get _halfHeight(){return"card"===this.nodeStyle?this._cardHalf:this._nodeR}_bgFill(t){return t.startsWith("rgb(")?t.replace("rgb(","rgba(").replace(")",", 0.15)"):`${t}26`}get _nodeMargin(){return this._halfHeight+("card"===this.nodeStyle?6:4)}_batteryColor(){const t=Math.max(0,Math.min(100,this.socPercent));let e,i,o;if(t>=50){const r=(t-50)/50;e=Math.round(16+229*r),i=Math.round(185+-27*r),o=Math.round(129+-118*r)}else{const r=t/50;e=Math.round(239+6*r),i=Math.round(68+90*r),o=Math.round(68+-57*r)}return`rgb(${e},${i},${o})`}_lineWidth(t){return t<=0?2:Math.min(8,Math.max(2,t/1e3*4+2))}_trim(t,e,i,o,r){const s=null!=r?r:this._nodeR+4,a=i-t,n=o-e,l=Math.sqrt(a*a+n*n);return 0===l?{x1:t,y1:e,x2:i,y2:o}:{x1:t+a/l*s,y1:e+n/l*s,x2:i-a/l*s,y2:o-n/l*s}}_flowLine(t,e,i,o,r,s,a=!1){const n=r>1,{x1:l,y1:d,x2:c,y2:h}=this._trim(t,e,i,o,this._nodeMargin),p=this._lineWidth(r),u=n?a?"flow-active-rev":"flow-active":"";return W`
      <line
        x1="${l}" y1="${d}" x2="${c}" y2="${h}"
        ...
        class="${u}"
      />
    `}_deviceLine(t,e,i,o,r,s){const a=r>5,{x1:n,y1:l,x2:d,y2:c}=this._trim(t,e,i,o,this._nodeR+3),h=d-n,p=c-l,u=Math.sqrt(h*h+p*p);return W`
      <line
        x1="${n}" y1="${l}" x2="${u>0?d-h/u*20:d}" y2="${u>0?c-p/u*20:c}"
        stroke="${s}" stroke-width="${a?2:1.5}" stroke-linecap="round"
        stroke-dasharray="${a?"6 5":"3 5"}" stroke-dashoffset="0"
        opacity="${a?.85:.2}"
        class="${a?"flow-active":""}"
      />
    `}_node(t,e,i,o,r,s,a,n,l){const d=this.textColor,c=this.editMode&&this._dragging===l,h="card"===this.nodeStyle,p=this._halfHeight,u=this.editMode?W`
      ${h?W`<rect x="${t-this._cardW/2-6}" y="${e-p-6}"
            width="${this._cardW+12}" height="${this._cardH+12}" rx="${this._cardR+4}"
            fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="1.5"
            stroke-dasharray="4 3" opacity="${c?1:.6}" />`:W`<circle cx="${t}" cy="${e}" r="${this._nodeR+6}"
            fill="none" stroke="rgba(255,255,255,0.35)" stroke-width="1.5"
            stroke-dasharray="4 3" opacity="${c?1:.6}" />`}
    `:"",v=h?W`<rect x="${t-this._cardW/2}" y="${e-p}"
          width="${this._cardW}" height="${this._cardH}" rx="${this._cardR}"
          fill="${a}" stroke="${s}" stroke-width="${c?3:2}" />`:W`<circle cx="${t}" cy="${e}" r="${this._nodeR}"
          fill="${a}" stroke="${s}" stroke-width="${c?3:2}" />`,g=this.nodeIconSize,y=W`
      <g transform="translate(${t-g}, ${e-g}) scale(${2*g/24})">
        <path d="${i}" fill="${s}" />
      </g>
    `;return W`
      <g
      ...
      >
        ...
        ${v}
        ${y}
        <text x="${t}" y="${e+p+14*this._textScale}" text-anchor="middle"
          font-size="${this._fsLabel}" font-family="Roboto, sans-serif"
          fill="${d}" opacity="0.65">${o}</text>
        <text x="${t}" y="${e+p+26*this._textScale}" text-anchor="middle"
          font-size="${this._fsValue}" font-weight="700" font-family="Roboto, sans-serif"
          fill="${d}">${_t(r,this.wattThreshold)}</text>
        ${n?W`
          <text x="${t}" y="${e+p+38*this._textScale}" text-anchor="middle"
            font-size="${this._fsSecondary}" font-family="Roboto, sans-serif"
            fill="${d}" opacity="0.65">${n}</text>
        `:""}
      </g>
    `}_deviceNode(t,e,i){const o=i.color||"#6366f1",r=o.startsWith("rgb")?o.replace("rgb(","rgba(").replace(")",", 0.15)"):`${o}26`,s=i.name.length>10?i.name.slice(0,9)+"…":i.name,a=i.watts>5,n=this.textColor;return W`
      <g class="device-node" opacity="${a?1:.45}">
        <circle cx="${t}" cy="${e}" r="${St}"
          fill="${r}" stroke="${o}" stroke-width="${a?2:1}" />
        <g transform="translate(${t-9}, ${e-9}) scale(${.75})">
          <path d="${"M7,2V13H10V22L17,10H13L17,2H7Z"}" fill="${o}" />
        </g>
        <text x="${t}" y="${e+St+11*this._textScale}" text-anchor="middle"
          font-size="${8.5*this._textScale}" font-family="Roboto, sans-serif"
          fill="${n}" opacity="0.65">${s}</text>
        <text x="${t}" y="${e+St+21*this._textScale}" text-anchor="middle"
          font-size="${9*this._textScale}" font-weight="700" font-family="Roboto, sans-serif"
          fill="${n}">${_t(i.watts,this.wattThreshold)}</text>
      </g>
    `}_socRing(t,e){const i=this._batteryColor(),o=e+this._halfHeight+(this.batterySecondary?50:38)*this._textScale;if("card"===this.nodeStyle)return W`
        <text x="${t}" y="${o}"
      ...
      `;const r=this._nodeR+5,s=2*Math.PI*r,a=this.socPercent/100*s;return W`
      <circle
        cx="${t}" cy="${e}" r="${r}"
        fill="none" stroke="${i}" stroke-width="3"
        stroke-dasharray="${a} ${s-a}"
        stroke-dashoffset="0"
      ...
      <text x="${t}" y="${o}"
        text-anchor="middle" font-size="${this._fsSecondary}" font-family="Roboto, sans-serif"
        fill="${i}" font-weight="600">${this.socPercent.toFixed(0)}%</text>
    `}render(){var t;const e=this.flows,i=this._pos,o=this.solarColor||"#f59e0b",r=this.gridColor||"#8b5cf6",s=this.homeColor||"#3b82f6",a=this.batteryNodeColor||this._batteryColor();this._batteryColor();const n=this._bgFill(a),l=null!==(t=this.diagramDevices)&&void 0!==t?t:[],d=l.length,c=d>0,h=i.home.x+82,p=52*(d-1),u=i.home.y-p/2,v=l.map((t,e)=>({d:t,x:h,y:u+52*e})),g=this._nodeR+60*this._textScale,y=[i.solar.x,i.grid.x,i.home.x,i.battery.x,...v.map(t=>t.x)],_=[i.solar.y,i.grid.y,i.home.y,i.battery.y,...v.map(t=>t.y)],f=Math.min(...y)-g,m=Math.min(..._)-g,b=Math.max(...y)+g+(c?47:0)-f,$=Math.max(..._)+g-m;return G`
      <svg
        viewBox="${`${f} ${m} ${b} ${$}`}"
      ...
      >
        ...
        ${this.showFlowLines?W`
          ...
          ${v.map(({d:t,x:e,y:o})=>this._deviceLine(i.home.x,i.home.y,e,o,t.watts,t.color||"#6366f1"))}
        `:""}
        ...
        ${v.map(({d:t,x:e,y:i})=>this._deviceNode(e,i,t))}
      </svg>
    `}updated(t){super.updated(t)}};kt.styles=a`
    :host { display: block; }
  ...
  `,t([vt({type:Number})],kt.prototype,"solar",void 0),t([vt({type:Number})],kt.prototype,"battery",void 0),t([vt({type:Number})],kt.prototype,"grid",void 0),t([vt({type:Number})],kt.prototype,"load",void 0),t([vt({type:Number})],kt.prototype,"socPercent",void 0),t([vt({type:Number})],kt.prototype,"wattThreshold",void 0),t([vt({type:String})],kt.prototype,"solarName",void 0),t([vt({type:String})],kt.prototype,"gridName",void 0),t([vt({type:String})],kt.prototype,"homeName",void 0),t([vt({type:String})],kt.prototype,"batteryName",void 0),t([vt({type:String})],kt.prototype,"solarSecondary",void 0),t([vt({type:String})],kt.prototype,"gridSecondary",void 0),t([vt({type:String})],kt.prototype,"homeSecondary",void 0),t([vt({type:String})],kt.prototype,"batterySecondary",void 0),t([vt({type:Object})],kt.prototype,"flows",void 0),t([vt({type:Array})],kt.prototype,"diagramDevices",void 0),t([vt({type:String})],kt.prototype,"backgroundImage",void 0),t([vt({type:Boolean})],kt.prototype,"editMode",void 0),t([vt({type:Object})],kt.prototype,"nodePositions",void 0),t([vt({type:String})],kt.prototype,"textColor",void 0),t([vt({type:String})],kt.prototype,"nodeStyle",void 0),t([vt({type:Boolean})],kt.prototype,"showFlowLines",void 0),t([vt({type:Number})],kt.prototype,"nodeIconSize",void 0),t([vt({type:Number})],kt.prototype,"nodeSize",void 0),t([vt({type:Number})],kt.prototype,"nodeTextSize",void 0),t([vt({type:String})],kt.prototype,"solarColor",void 0),t([vt({type:String})],kt.prototype,"gridColor",void 0),t([vt({type:String})],kt.prototype,"homeColor",void 0),t([vt({type:String})],kt.prototype,"batteryNodeColor",void 0),t([gt()],kt.prototype,"_pos",void 0),t([gt()],kt.prototype,"_dragging",void 0),kt=t([ht("flow-diagram")],kt);let Pt=class extends dt{constructor(){super(...arguments),this.entityId="",this.name="",this.icon="",this.value=0,this.unit="W",this.stateLabel="",this.stateColor="#3b82f6",this.panelClass="",this.badgeClass="",this.showSparkline=!0,this.sparklineHistory=[],this.displayValue=""}updated(t){super.updated(t),this.showSparkline&&t.has("sparklineHistory")&&this._drawSparkline(),t.has("showSparkline")&&this.showSparkline&&this.updateComplete.then(()=>this._drawSparkline())}_drawSparkline(){var t;const e=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("canvas");if(!e)return;const i=this.sparklineHistory;if(!i||i.length<2)return;const o=window.devicePixelRatio||1,r=e.getBoundingClientRect(),s=r.width||200,a=r.height||48;e.width=s*o,e.height=a*o;const n=e.getContext("2d");if(!n)return;n.scale(o,o),n.clearRect(0,0,s,a);const l=i.slice(-60),d=l.map(t=>t.value),c=Math.min(...d),h=Math.max(...d)-c||1,p=t=>t/(l.length-1)*s,u=t=>a-4-(t-c)/h*(a-8),v=n.createLinearGradient(0,0,0,a);v.addColorStop(0,this.stateColor+"55"),v.addColorStop(1,this.stateColor+"00"),n.beginPath(),n.moveTo(p(0),a),l.forEach((t,e)=>n.lineTo(p(e),u(t.value))),n.lineTo(p(l.length-1),a),n.closePath(),n.fillStyle=v,n.fill(),n.beginPath(),n.strokeStyle=this.stateColor,n.lineWidth=1.5,n.lineJoin="round",n.lineCap="round",l.forEach((t,e)=>{0===e?n.moveTo(p(e),u(t.value)):n.lineTo(p(e),u(t.value))}),n.stroke()}_openMoreInfo(){this.entityId&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this.entityId},bubbles:!0,composed:!0}))}render(){var t;const e=this.displayValue||`${Math.round(Math.abs(this.value))} W`;return G`
      <div
        ...
        @keydown="${t=>{"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this._openMoreInfo())}}"
      >
        <div class="header">
          <div class="icon-wrap">
            ${(null===(t=this.icon)||void 0===t?void 0:t.startsWith("mdi:"))?G`<ha-icon icon="${this.icon}" style="color:${this.stateColor};"></ha-icon>`:G`<svg viewBox="0 0 24 24" fill="${this.stateColor}" aria-hidden="true">
                  <path d="${this.icon}" />
                </svg>`}
          </div>
      ...
      <div class="row" role="list" aria-label="Device power consumption">
        ${t.map(t=>{var e;return G`
            <div
              ...
              role="listitem"
              tabindex="0"
              title="${t.name}: ${_t(t.watts,this.wattThreshold)}"
              style="${t.color?`border-color: ${t.color}33;`:""}"
              @click="${()=>this._openMoreInfo(t.entityId)}"
              @keydown="${e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this._openMoreInfo(t.entityId))}}"
            >
              ...
              <span class="chip-value">${_t(t.watts,this.wattThreshold)}</span>
            </div>
          `})}
      </div>
    `}};Ct.styles=a`
  ...
  `,t([vt({type:Array})],Ct.prototype,"devices",void 0),t([vt({type:Number})],Ct.prototype,"wattThreshold",void 0),Ct=t([ht("device-row")],Ct);const Ht=[{key:"solar",enabled:!0},{key:"battery",enabled:!0},{key:"grid",enabled:!0},{key:"load",enabled:!0}];function At(t){return Math.round((null!=t?t:32)/32*18)}let Et=class extends dt{constructor(){super(...arguments),this._solar=0,this._battery=0,this._grid=0,this._load=0,this._soc=0,this._solarExport=0,this._gridToBattery=0,this._flows={solarToHome:0,solarToBattery:0,solarToGrid:0,gridToHome:0,batteryToHome:0,gridToBattery:0,batteryToGrid:0},this._sparklines={},this._error=null,this._lastSparklineFetch=0,this._sparklineDebounceMs=3e5}get hass(){return this._hass}static getStubConfig(){return{solar:{entity:"sensor.solar_power"},battery:{entity:"sensor.battery_power",soc_entity:"sensor.battery_soc"},grid:{entity:"sensor.grid_power"},load:{entity:"sensor.load_power"}}}static getConfigElement(){return document.createElement("solar-overview-card-editor")}setConfig(t){var e,i,o;if(!(null===(e=t.solar)||void 0===e?void 0:e.entity))throw new Error('solar-overview-card: "solar.entity" required');if(!(null===(i=t.battery)||void 0===i?void 0:i.entity))throw new Error('solar-overview-card: "battery.entity" required');const r=t.grid,s=!!(null===(o=t.load)||void 0===o?void 0:o.entity),a=!!((null==r?void 0:r.entity)||(null==r?void 0:r.import_entity)||(null==r?void 0:r.export_entity)||(null==r?void 0:r.battery_entity));if(!s&&!a)throw new Error("solar-overview-card: at least one of load.entity or a grid entity is required");this._config={watt_threshold:1e3,show_sparklines:!0,theme:"auto",show_flow:!0,show_stats:!0,show_devices:!0,...t},this._error=null}getCardSize(){return 4}set hass(t){if(this._hass=t,this._config)try{const t=xt(this._config,t=>this._readEntity(t));this._solar=t.solar,this._battery=t.battery,this._grid=t.grid,this._load=t.load,this._soc=this._config.battery.soc_entity?this._readEntity(this._config.battery.soc_entity):0,this._flows=bt(t.flowParams),this._error=null;const e=Date.now();!1!==this._config.show_sparklines&&e-this._lastSparklineFetch>this._sparklineDebounceMs&&(this._lastSparklineFetch=e,this._fetchSparklines())}catch(t){this._error=t.message}}_readEntity(t){var e;if(!t||!(null===(e=this._hass)||void 0===e?void 0:e.states))return 0;const i=this._hass.states[t];return i?ft(i.state,i.attributes.unit_of_measurement):0}async _fetchSparklines(){var t,e,i,o;if(!this._config||!(null===(t=this._hass)||void 0===t?void 0:t.callApi))return;const r=(null!==(e=this._config.panels)&&void 0!==e?e:[]).filter(t=>!t.key&&t.entity).map(t=>t.entity),s=[this._config.solar.entity,this._config.battery.entity,null!==(i=this._config.grid.entity)&&void 0!==i?i:this._config.grid.import_entity,this._config.load.entity,...r].filter(t=>!!t),a=new Date,n=null!==(o=this._config.sparkline_hours)&&void 0!==o?o:2,l=new Date(a.getTime()-60*n*60*1e3).toISOString(),d={};await Promise.allSettled(s.map(async t=>{try{const e=`history/period/${l}?filter_entity_id=${t}&minimal_response=true&no_attributes=true`,i=await this._hass.callApi("GET",e);if(!Array.isArray(i)||0===i.length)return;d[t]=i[0].map(t=>{const e=mt(t.state);return isNaN(e)?null:{time:new Date(t.last_updated).getTime(),value:e}}).filter(t=>null!==t)}catch{}})),this._sparklines={...this._sparklines,...d}}_threshold(){var t,e;return null!==(e=null===(t=this._config)||void 0===t?void 0:t.watt_threshold)&&void 0!==e?e:1e3}_secondaryLabel(t){var e,i;if(!t||!(null===(e=this._hass)||void 0===e?void 0:e.states))return"";const o=this._hass.states[t];if(!o)return"";const r=null!==(i=o.attributes.unit_of_measurement)&&void 0!==i?i:"";return"W"===r?_t(mt(o.state),this._threshold()):"kW"===r?_t(1e3*mt(o.state),this._threshold()):r?`${o.state} ${r}`:o.state}_customPanel(t){var e,i,o,r,s,a,n,l,d;const c=t.entity,h=null===(e=this._hass)||void 0===e?void 0:e.states[c],p=mt(null==h?void 0:h.state),u=null!==(o=null===(i=null==h?void 0:h.attributes)||void 0===i?void 0:i.unit_of_measurement)&&void 0!==o?o:"",v=this._threshold(),g="W"===u||"kW"===u?_t(p,v):u?`${Number.isInteger(p)?p:p.toFixed(1)} ${u}`:`${Math.round(p)}`,y=null!==(r=t.color)&&void 0!==r?r:"#6366f1",_=null!==(n=null!==(s=t.name)&&void 0!==s?s:null===(a=null==h?void 0:h.attributes)||void 0===a?void 0:a.friendly_name)&&void 0!==n?n:c,f=t.icon||wt;return G`
      <stat-panel
        .entityId="${c}"
        .name="${_}"
        .icon="${f}"
      ...
      ></stat-panel>
    `}_deviceItems(){var t,e;return(null===(t=this._config)||void 0===t?void 0:t.devices)&&(null===(e=this._hass)||void 0===e?void 0:e.states)?this._config.devices.map(t=>{var e,i;return{entityId:t.entity,name:null!==(e=t.name)&&void 0!==e?e:t.entity,icon:null!==(i=t.icon)&&void 0!==i?i:wt,watts:this._readEntity(t.entity),color:t.color}}):[]}_diagramDevices(){var t,e;return(null===(t=this._config)||void 0===t?void 0:t.devices)&&(null===(e=this._hass)||void 0===e?void 0:e.states)?this._config.devices.filter(t=>t.show_on_diagram).map(t=>{var e,i;return{name:null!==(e=t.name)&&void 0!==e?e:t.entity,watts:this._readEntity(t.entity),color:null!==(i=t.color)&&void 0!==i?i:"#6366f1"}}):[]}_panelProps(t,e,i,o,r,s,a){var n,l,d,c;const h=this._threshold(),p=this._config[t];return{entityId:s,name:null!==(n=null==p?void 0:p.name)&&void 0!==n?n:i,icon:null!==(l=null==p?void 0:p.icon)&&void 0!==l?l:o,value:e,displayValue:_t(e,h),stateLabel:null!=a?a:$t(t,e),stateColor:r,showSparkline:!1!==(null===(d=this._config)||void 0===d?void 0:d.show_sparklines),sparklineHistory:null!==(c=this._sparklines[s])&&void 0!==c?c:[],panelClass:`panel--${t}`,badgeClass:`badge--${t}`}}render(){var t,e,i,o,r,s,a,n,l,d,c,h,p,u,v,g,y,_,f,m,b,$;if(!this._config)return G`<ha-card><div class="error-card">solar-overview-card: no config.</div></ha-card>`;if(this._error)return G`<ha-card><div class="error-card">Error: ${this._error}</div></ha-card>`;const x=this._threshold(),w=!1!==this._config.show_flow,S=!1!==this._config.show_stats,k=!1!==this._config.show_devices,P=this._panelProps("solar",this._solar,"Solar","M4,2H20A2,2 0 0,1 22,4V20A2,2 0 0,1 20,22H4A2,2 0 0,1 2,20V4A2,2 0 0,1 4,2M4,4V20H20V4H4M5,5H11V11H5V5M13,5H19V11H13V5M5,13H11V19H5V13M13,13H19V19H13V13Z","#f59e0b",this._config.solar.entity),C=this._config.battery.status_entity&&null!==(i=null===(e=null===(t=this._hass)||void 0===t?void 0:t.states[this._config.battery.status_entity])||void 0===e?void 0:e.state)&&void 0!==i?i:void 0,H=this._panelProps("battery",this._battery,"Battery","M16,20H8V6H16M16.67,4H15V2H9V4H7.33A1.33,1.33 0 0,0 6,5.33V20.67C6,21.4 6.6,22 7.33,22H16.67A1.33,1.33 0 0,0 18,20.67V5.33C18,4.6 17.4,4 16.67,4Z","#10b981",this._config.battery.entity,C),A=this._config.grid.entity?this._grid:this._flows.gridToHome+this._flows.gridToBattery-(this._flows.solarToGrid+this._flows.batteryToGrid),E=this._panelProps("grid",A,"Grid","M11.5,3.5L10.5,6H13.5L12.5,3.5H11.5M10,7L8.5,10H15.5L14,7H10M8,11L5,17H8L9,14H15L16,17H19L16,11H8M8,18L11,21H13L16,18H8Z","#8b5cf6",null!==(r=null!==(o=this._config.grid.entity)&&void 0!==o?o:this._config.grid.import_entity)&&void 0!==r?r:""),M=this._flows.solarToHome+this._flows.batteryToHome+this._flows.gridToHome,T=this._config.load.entity?this._load:M,z=this._panelProps("load",T,"Home","M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z","#3b82f6",null!==(s=this._config.load.entity)&&void 0!==s?s:""),N=this._deviceItems();return G`
      <ha-card>
        <div class="card" theme="${null!==(a=this._config.theme)&&void 0!==a?a:"auto"}">
          ...
          ${w?G`
            <div class="flow-diagram">
              <flow-diagram
                ...
                .solarName="${null!==(n=this._config.solar.name)&&void 0!==n?n:"Solar"}"
                .gridName="${null!==(l=this._config.grid.name)&&void 0!==l?l:"Grid"}"
                .homeName="${null!==(d=this._config.load.name)&&void 0!==d?d:"Home"}"
                .batteryName="${null!==(c=this._config.battery.name)&&void 0!==c?c:"Battery"}"
                .solarColor="${null!==(h=this._config.solar.color)&&void 0!==h?h:""}"
                .gridColor="${null!==(p=this._config.grid.color)&&void 0!==p?p:""}"
                .homeColor="${null!==(u=this._config.load.color)&&void 0!==u?u:""}"
                .batteryNodeColor="${null!==(v=this._config.battery.color)&&void 0!==v?v:""}"
                .backgroundImage="${null!==(g=this._config.flow_background)&&void 0!==g?g:""}"
                .textColor="${null!==(y=this._config.diagram_text_color)&&void 0!==y?y:"#ffffff"}"
                .nodeStyle="${null!==(_=this._config.node_style)&&void 0!==_?_:"circle"}"
                .nodeSize="${null!==(f=this._config.node_size)&&void 0!==f?f:32}"
                .nodeTextSize="${null!==(m=this._config.node_text_size)&&void 0!==m?m:11}"
                .nodeIconSize="${null!==(b=this._config.node_icon_size)&&void 0!==b?b:At(this._config.node_size)}"
          ...
          ${S?G`
            <div class="stat-grid">
              ${(null!==($=this._config.panels)&&void 0!==$?$:Ht).filter(t=>!1!==t.enabled).map(t=>{if(t.key){const e={solar:P,battery:H,grid:E,load:z}[t.key];return G`
                      <stat-panel
                        .entityId="${e.entityId}"
                        .name="${e.name}"
                        .icon="${e.icon}"
          ...
          ${k&&this._config.devices&&this._config.devices.length>0?G`
    ...
    `}updated(t){super.updated(t)}};Et.styles=[yt,a`:host { display: block; } ha-card { overflow: hidden; }`],t([gt()],Et.prototype,"_config",void 0),t([gt()],Et.prototype,"_solar",void 0),t([gt()],Et.prototype,"_battery",void 0),t([gt()],Et.prototype,"_grid",void 0),t([gt()],Et.prototype,"_load",void 0),t([gt()],Et.prototype,"_soc",void 0),t([gt()],Et.prototype,"_solarExport",void 0),t([gt()],Et.prototype,"_gridToBattery",void 0),t([gt()],Et.prototype,"_flows",void 0),t([gt()],Et.prototype,"_sparklines",void 0),t([gt()],Et.prototype,"_error",void 0),Et=t([ht("solar-overview-card")],Et);let Mt=class extends dt{constructor(){super(...arguments),this._page="main",this._newDevice={entity:"",name:"",icon:"mdi:power-socket",color:"#6366f1",show_on_diagram:!1},this._editingIndex=null,this._editingDevice={entity:"",name:"",icon:"",color:"#6366f1",show_on_diagram:!1},this._newPanel={entity:"",name:"",icon:"",color:"#6366f1"},this._editingPanel={name:"",icon:"",color:"#6366f1"},this._editingPanelIndex=null}setConfig(t){this._config=t}_setValue(t,e){var i;if(!this._config)return;const o=t.split("."),r=JSON.parse(JSON.stringify(this._config)),s=r;if(2===o.length){const[t,r]=o,a={...null!==(i=s[t])&&void 0!==i?i:{}};""===e||null==e?delete a[r]:a[r]=e,s[t]=a}else""===e||null==e?delete s[o[0]]:s[o[0]]=e;this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:r}}))}_computeCurrentFlows(){if(!this.hass||!this._config)return null;try{const t=t=>{if(!t)return 0;const e=this.hass.states[t];return e?ft(e.state,e.attributes.unit_of_measurement):0};return bt(xt(this._config,t).flowParams)}catch{return null}}_pageHeader(t,e){return G`
    ...
    `}_renderMain(){var t,e,i,o,r,s,a,n,l,d,c,h,p;if(!this._config)return G``;const u=this._config,v=null!==(e=null===(t=u.devices)||void 0===t?void 0:t.length)&&void 0!==e?e:0,g=(t,e,i,o,r)=>G`
    ...
    `,y=(null!==(i=u.panels)&&void 0!==i?i:Ht).filter(t=>!1!==t.enabled).length;return G`
      <div class="nav-list">
        ${g("setup","⚙️","Setup","Visibility & sparklines","rgba(107,114,128,0.18)")}
        ${g("solar","☀️","Solar",null!==(r=null===(o=u.solar)||void 0===o?void 0:o.entity)&&void 0!==r?r:"Not configured","rgba(245,158,11,0.18)")}
        ${g("battery","🔋","Battery",null!==(a=null===(s=u.battery)||void 0===s?void 0:s.entity)&&void 0!==a?a:"Not configured","rgba(16,185,129,0.18)")}
        ${g("grid","⚡","Grid",null!==(c=null!==(l=null===(n=u.grid)||void 0===n?void 0:n.entity)&&void 0!==l?l:null===(d=u.grid)||void 0===d?void 0:d.import_entity)&&void 0!==c?c:"Not configured","rgba(139,92,246,0.18)")}
        ${g("house","🏠","House",null!==(p=null===(h=u.load)||void 0===h?void 0:h.entity)&&void 0!==p?p:"Not configured","rgba(59,130,246,0.18)")}
        ${g("panels","📊","Panels",`${y} of 4 shown`,"rgba(6,182,212,0.18)")}
        ${g("outlets","🔌","Outlets",v>0?`${v} device${1!==v?"s":""}`:"No devices added","rgba(99,102,241,0.18)")}
        ${g("layout","🗺️","Layout","Drag nodes to reposition","rgba(16,185,129,0.18)")}
      </div>
    `}_renderSetupPage(){var t,e,i,o,r,s;if(!this._config)return G``;const a=this._config;return G`
      ${this._pageHeader("⚙️","Setup")}
      <div class="form-col">
        <div class="section-label" style="margin-top:0;">Sections</div>
        ${this._boolField("Show flow diagram","show_flow",!1!==a.show_flow)}
        ${this._boolField("Show stat panels","show_stats",!1!==a.show_stats)}
        ${this._boolField("Show devices row","show_devices",!1!==a.show_devices)}
        ${this._boolField("Show sparklines","show_sparklines",!1!==a.show_sparklines)}
        ...
        <div class="bool-row">
          ...
          <ha-selector
            ...
            .value="${null!==(t=a.node_style)&&void 0!==t?t:"circle"}"
            @value-changed="${t=>this._setValue("node_style",t.detail.value)}"
          ></ha-selector>
        </div>
        ${this._boolField("Show animated flow lines","show_flow_lines",!1!==a.show_flow_lines)}
        <ha-selector
          .label="Node size (default: 32)"
          .selector=${{number:{min:20,max:64,step:2,mode:"slider"}}}
          .value="${null!==(e=a.node_size)&&void 0!==e?e:32}"
          @value-changed="${t=>this._setValue("node_size",t.detail.value)}"
        ></ha-selector>
        ...
        <ha-selector
          ...
          .value="${null!==(i=a.node_icon_size)&&void 0!==i?i:At(a.node_size)}"
          @value-changed="${t=>this._setValue("node_icon_size",t.detail.value)}"
        ></ha-selector>
        ...
        <ha-selector
          ...
          .value="${null!==(o=a.node_text_size)&&void 0!==o?o:11}"
          @value-changed="${t=>this._setValue("node_text_size",t.detail.value)}"
        ></ha-selector>
        ...
        <div class="color-row">
          ...
          <input type="color"
            .value="${null!==(r=a.diagram_text_color)&&void 0!==r?r:"#ffffff"}"
            @input="${t=>this._setValue("diagram_text_color",t.target.value)}"
          />
          ${a.diagram_text_color&&"#ffffff"!==a.diagram_text_color?G`
        ...
        ${this._textField("Background image URL or /local/ path","flow_background",a.flow_background)}
        ...
        <ha-selector
          ...
          .value="${null!==(s=a.sparkline_hours)&&void 0!==s?s:2}"
    ...
    `}_renderHousePage(){var t;if(!this._config)return G``;const e=this._config.load,i=this._computeCurrentFlows(),o=null!==(t=this._config.watt_threshold)&&void 0!==t?t:1e3,r=t=>_t(t,o);return G`
    ...
    `}_renderLayoutPage(){var t,e,i,o,r,s,a,n,l,d,c,h,p,u;if(!this._config)return G``;const v=this._config,g=v.grid,y=t=>{var e,i,o;return t?mt(null!==(o=null===(i=null===(e=this.hass)||void 0===e?void 0:e.states[t])||void 0===i?void 0:i.state)&&void 0!==o?o:"0"):0},_="discharging"===v.battery.positive_means||!0===v.battery.invert,f="exporting"===g.positive_means||!0===g.invert,m=y(v.solar.entity)*(v.solar.invert?-1:1),b=y(v.battery.entity)*(_?-1:1),$=y(null===(t=v.load)||void 0===t?void 0:t.entity)*((null===(e=v.load)||void 0===e?void 0:e.invert)?-1:1),x=g.entity?y(g.entity)*(f?-1:1):0,w=y(v.battery.soc_entity),S=(()=>{try{return bt({solar:m,battery:b,load:$,gridCombined:x,gridImport:g.import_entity?y(g.import_entity):void 0,gridExport:g.export_entity?y(g.export_entity):void 0,gridToBattery:g.to_battery_entity?y(g.to_battery_entity):void 0,batteryToGrid:g.from_battery_entity?y(g.from_battery_entity):void 0,gridBatteryCombined:g.battery_entity?y(g.battery_entity):void 0})}catch{return{solarToHome:0,solarToBattery:0,solarToGrid:0,gridToHome:0,batteryToHome:0,gridToBattery:0,batteryToGrid:0}}})(),k=!!v.node_positions&&Object.keys(v.node_positions).length>0;return G`
      ...
      <div class="form-col">
        ...
        <div style="border:1px solid var(--divider-color,rgba(255,255,255,0.1));border-radius:10px;overflow:hidden;">
          <flow-diagram
            ...
            .load="${$}"
            .socPercent="${w}"
            .wattThreshold="${null!==(i=v.watt_threshold)&&void 0!==i?i:1e3}"
            .flows="${S}"
            .solarName="${null!==(o=v.solar.name)&&void 0!==o?o:"Solar"}"
            .gridName="${null!==(r=v.grid.name)&&void 0!==r?r:"Grid"}"
            .homeName="${null!==(a=null===(s=v.load)||void 0===s?void 0:s.name)&&void 0!==a?a:"Home"}"
            .batteryName="${null!==(n=v.battery.name)&&void 0!==n?n:"Battery"}"
            .textColor="${null!==(l=v.diagram_text_color)&&void 0!==l?l:"#ffffff"}"
            .nodeStyle="${null!==(d=v.node_style)&&void 0!==d?d:"circle"}"
            .nodeSize="${null!==(c=v.node_size)&&void 0!==c?c:32}"
            .nodeTextSize="${null!==(h=v.node_text_size)&&void 0!==h?h:11}"
            .nodeIconSize="${null!==(p=v.node_icon_size)&&void 0!==p?p:At(v.node_size)}"
            .showFlowLines="${!1!==v.show_flow_lines}"
            .nodePositions="${v.node_positions}"
            .backgroundImage="${null!==(u=v.flow_background)&&void 0!==u?u:""}"
            .editMode="${!0}"
    ...
    `}_renderPanelsPage(){var t;if(!this._config)return G``;const e=null!==(t=this._config.panels)&&void 0!==t?t:Ht,i={solar:{icon:"☀️",label:"Solar"},battery:{icon:"🔋",label:"Battery"},grid:{icon:"⚡",label:"Grid"},load:{icon:"🏠",label:"House"}};return G`
      ...
      <div class="form-col">
        ${e.map((t,o)=>{var r,s,a;const n=!!t.key,l=n?i[t.key].icon:"📈",d=n?i[t.key].label:null!==(s=null!==(r=t.name)&&void 0!==r?r:t.entity)&&void 0!==s?s:"Custom",c=!n&&t.entity?G`<span class="nav-sub" style="margin:0;">${t.entity}</span>`:"";return G`
            <div class="panel-item">
              ...
              ${n?"":G`
                <button class="device-btn" title="Edit"
                  @click="${()=>this._editingPanelIndex===o?this._cancelPanelEdit():this._startPanelEdit(o)}">✏️</button>
            ...
            ${this._editingPanelIndex===o?this._panelEditForm():""}
          `})}
        ...
        <div class="add-device-form">
          ...
          <div class="add-device-row">
            ...
            <ha-selector .label="Icon" .selector=${{icon:{}}} .value="${this._newPanel.icon}"
              @value-changed="${t=>{var e;this._newPanel={...this._newPanel,icon:null!==(e=t.detail.value)&&void 0!==e?e:""},this.requestUpdate()}}"
            ></ha-selector>
          </div>
          <div class="color-row">
            <label>Colour</label>
    ...
    `}_addCustomPanel(){var t;if(!this._config||!this._newPanel.entity)return;const e=[...null!==(t=this._config.panels)&&void 0!==t?t:Ht,{entity:this._newPanel.entity,name:this._newPanel.name||void 0,icon:this._newPanel.icon||void 0,color:this._newPanel.color||"#6366f1",enabled:!0}];this._setPanels(e),this._newPanel={entity:"",name:"",icon:"",color:"#6366f1"}}_removeCustomPanel(t){var e,i;const o=[...null!==(i=null===(e=this._config)||void 0===e?void 0:e.panels)&&void 0!==i?i:Ht];o.splice(t,1),this._setPanels(o)}_setPanels(t){this._config&&this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config,panels:t}}}))}_startPanelEdit(t){var e,i,o,r,s;const a=(null!==(i=null===(e=this._config)||void 0===e?void 0:e.panels)&&void 0!==i?i:Ht)[t];this._editingPanel={name:null!==(o=a.name)&&void 0!==o?o:"",icon:null!==(r=a.icon)&&void 0!==r?r:"",color:null!==(s=a.color)&&void 0!==s?s:"#6366f1"},this._editingPanelIndex=t}_cancelPanelEdit(){this._editingPanelIndex=null}_savePanelEdit(){var t;if(null===this._editingPanelIndex||!this._config)return;const e=[...null!==(t=this._config.panels)&&void 0!==t?t:Ht];e[this._editingPanelIndex]={...e[this._editingPanelIndex],name:this._editingPanel.name||void 0,icon:this._editingPanel.icon||void 0,color:this._editingPanel.color||void 0},this._editingPanelIndex=null,this._setPanels(e)}_panelEditForm(){const t=this._editingPanel,e=e=>{this._editingPanel={...t,...e}};return G`
      <div class="add-device-form">
        <div class="add-device-row">
  ...
  `,t([vt({attribute:!1})],Mt.prototype,"hass",void 0),t([gt()],Mt.prototype,"_config",void 0),t([gt()],Mt.prototype,"_page",void 0),t([gt()],Mt.prototype,"_newDevice",void 0),t([gt()],Mt.prototype,"_editingIndex",void 0),t([gt()],Mt.prototype,"_editingDevice",void 0),t([gt()],Mt.prototype,"_newPanel",void 0),t([gt()],Mt.prototype,"_editingPanel",void 0),t([gt()],Mt.prototype,"_editingPanelIndex",void 0),Mt=t([ht("solar-overview-card-editor")],Mt),window.customCards=window.customCards||[],window.customCards.push({type:"solar-overview-card",name:"Solar Overview Card",description:"Animated solar energy overview with power flow diagram",preview:!0});export{Et as SolarOverviewCard,Mt as SolarOverviewCardEditor};
