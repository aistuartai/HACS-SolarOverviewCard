 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ft(t){return ut({...t,state:!0,attribute:!1})}const yt=a`
  /* ─── Colour tokens ───────────────────────────────────────────── */
  :host {
    --color-solar:   #f59e0b;
...
`;function vt(t,e){return Math.abs(t)>=e?`${(t/1e3).toFixed(1)} kW`:`${Math.round(t)} W`}function _t(t){if(null==t)return 0;const e="number"==typeof t?t:parseFloat(t);return isNaN(e)?0:e}function mt(t,e){const i=t.toLowerCase();return i.includes("solar")||i.includes("pv")?e>0?"Generating":"Idle":i.includes("battery")||i.includes("batt")?e>0?"Charging":e<0?"Discharging":"Idle":i.includes("grid")?e>0?"Importing":e<0?"Exporting":"Idle":i.includes("load")||i.includes("home")||i.includes("consumption")?e>0?"Consuming":"Idle":e>0?"Active":"Idle"}const bt=300,$t=150,wt=150,xt=$t,At=wt,St=250,kt=wt,Ht=$t,Et=250,Ct=32;let Mt=class extends dt{constructor(){super(...arguments),this.solar=0,this.battery=0,this.grid=0,this.load=0,this.socPercent=0,this.wattThreshold=1e3,this.flows={solarToHome:0,solarToBattery:0,solarToGrid:0,gridToHome:0,batteryToHome:0,gridToBattery:0}}_lineWidth(t){const e=Math.abs(t);return e<=0?2:Math.min(8,Math.max(2,e/1e3*4+2))}_trim(t,e,i,o,r=36){const s=i-t,a=o-e,n=Math.sqrt(s*s+a*a),l=s/n,d=a/n;return{x1:t+l*r,y1:e+d*r,x2:i-l*r,y2:o-d*r}}_flowLine(t,e,i,o,r,s,a=!1){const n=r>1,{x1:l,y1:d,x2:h,y2:c}=this._trim(t,e,i,o),p=this._lineWidth(r),g=n?function(t,e){if(e<=0)return 1;const i=Math.abs(t)/e;return Math.min(1,Math.max(.2,i))}(r,5e3):1;return q`
      ...
      />
    `}_node(t,e,i,o,r,s,a){const n=vt(r,this.wattThreshold);return q`
      <g class="node">
        <!-- background circle -->
    ...
    `}_socRing(){const t=2*Math.PI*37,e=this.socPercent/100*t,i=t-e,o=this.socPercent>60?"#10b981":this.socPercent>25?"#f59e0b":"#ef4444";return q`
      <circle
        cx="${Ht}" cy="${Et}"
        r="${37}"
        fill="none"
    ...
    `}render(){const t=this.flows;return G`
      ...
      >
        ...
        <!-- Solar → Home -->
        ${this._flowLine(xt,50,St,kt,t.solarToHome,"#f59e0b")}
        ...
        <!-- Grid → Home (import) -->
        ${this._flowLine(50,At,St,kt,t.gridToHome,"#8b5cf6")}

        <!-- Battery → Home (discharge) -->
        ${this._flowLine(Ht,Et,St,kt,t.batteryToHome,"#10b981")}
        ...
        ${this._node(St,kt,"M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z","Home",this.load,"#3b82f6","rgba(59,130,246,0.15)")}

        ${this._node(Ht,Et,"M16,20H8V6H16M16.67,4H15V2H9V4H7.33A1.33,1.33 0 0,0 6,5.33V20.67C6,21.4 6.6,22 7.33,22H16.67A1.33,1.33 0 0,0 18,20.67V5.33C18,4.6 17.4,4 16.67,4Z","Battery",this.battery,"#10b981","rgba(16,185,129,0.15)")}
      </svg>
  ...
  `,t([ut({type:Number})],Mt.prototype,"solar",void 0),t([ut({type:Number})],Mt.prototype,"battery",void 0),t([ut({type:Number})],Mt.prototype,"grid",void 0),t([ut({type:Number})],Mt.prototype,"load",void 0),t([ut({type:Number})],Mt.prototype,"socPercent",void 0),t([ut({type:Number})],Mt.prototype,"wattThreshold",void 0),t([ut({type:Object})],Mt.prototype,"flows",void 0),Mt=t([ct("flow-diagram")],Mt);let Pt=class extends dt{constructor(){super(...arguments),this.entityId="",this.name="",this.icon="",this.value=0,this.unit="W",this.stateLabel="",this.stateColor="#3b82f6",this.panelClass="",this.badgeClass="",this.showSparkline=!0,this.sparklineHistory=[],this.displayValue="",this._canvasReady=!1}updated(t){super.updated(t),this.showSparkline&&t.has("sparklineHistory")&&this._drawSparkline(),t.has("showSparkline")&&this.showSparkline&&(this._canvasReady=!0,this.requestUpdate(),this.updateComplete.then(()=>this._drawSparkline()))}_drawSparkline(){var t;const e=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("canvas");if(!e)return;const i=this.sparklineHistory;if(!i||i.length<2)return;const o=window.devicePixelRatio||1,r=e.getBoundingClientRect(),s=r.width||200,a=r.height||48;e.width=s*o,e.height=a*o;const n=e.getContext("2d");if(!n)return;n.scale(o,o),n.clearRect(0,0,s,a);const l=i.slice(-60),d=l.map(t=>t.value),h=Math.min(...d),c=Math.max(...d)-h||1,p=t=>t/(l.length-1)*s,g=t=>a-4-(t-h)/c*(a-8),u=n.createLinearGradient(0,0,0,a);u.addColorStop(0,this.stateColor+"55"),u.addColorStop(1,this.stateColor+"00"),n.beginPath(),n.moveTo(p(0),a),l.forEach((t,e)=>n.lineTo(p(e),g(t.value))),n.lineTo(p(l.length-1),a),n.closePath(),n.fillStyle=u,n.fill(),n.beginPath(),n.strokeStyle=this.stateColor,n.lineWidth=1.5,n.lineJoin="round",n.lineCap="round",l.forEach((t,e)=>{0===e?n.moveTo(p(e),g(t.value)):n.lineTo(p(e),g(t.value))}),n.stroke()}render(){const t=this.displayValue||`${Math.round(Math.abs(this.value))} W`;return G`
  ...
  `,t([ut({type:Array})],Tt.prototype,"devices",void 0),t([ut({type:Number})],Tt.prototype,"wattThreshold",void 0),Tt=t([ct("device-row")],Tt);let Vt=class extends dt{constructor(){super(...arguments),this._solar=0,this._battery=0,this._grid=0,this._load=0,this._soc=0,this._solarExport=0,this._gridToBattery=0,this._flows={solarToHome:0,solarToBattery:0,solarToGrid:0,gridToHome:0,batteryToHome:0,gridToBattery:0},this._sparklines={},this._error=null,this._lastSparklineFetch=0,this._sparklineDebounceMs=3e5}get hass(){return this._hass}static getStubConfig(){return{solar:{entity:"sensor.solar_power"},battery:{entity:"sensor.battery_power",soc_entity:"sensor.battery_soc"},grid:{entity:"sensor.grid_power"},load:{entity:"sensor.load_power"}}}static getConfigElement(){return document.createElement("solar-overview-card-editor")}setConfig(t){var e,i,o,r;if(!(null===(e=t.solar)||void 0===e?void 0:e.entity))throw new Error('solar-overview-card: "solar.entity" required');if(!(null===(i=t.battery)||void 0===i?void 0:i.entity))throw new Error('solar-overview-card: "battery.entity" required');if(!(null===(o=t.grid)||void 0===o?void 0:o.entity))throw new Error('solar-overview-card: "grid.entity" required');if(!(null===(r=t.load)||void 0===r?void 0:r.entity))throw new Error('solar-overview-card: "load.entity" required');this._config={watt_threshold:1e3,show_sparklines:!0,theme:"auto",show_flow:!0,show_stats:!0,show_devices:!0,...t},this._error=null}getCardSize(){return 4}set hass(t){var e,i,o,r,s,a;if(this._hass=t,this._config)try{const t=this._readEntity(this._config.solar.entity),n=this._readEntity(this._config.battery.entity),l=this._readEntity(this._config.grid.entity),d=this._readEntity(this._config.load.entity);this._solar=this._config.solar.invert?-t:t,this._battery=this._config.battery.invert?-n:n,this._grid=this._config.grid.invert?-l:l,this._load=this._config.load.invert?-d:d,this._config.battery.soc_entity&&(this._soc=this._readEntity(this._config.battery.soc_entity)),this._solarExport=this._config.solar.export_entity?this._readEntity(this._config.solar.export_entity):0,this._gridToBattery=this._config.battery.grid_charge_entity?this._readEntity(this._config.battery.grid_charge_entity):0,this._flows=(e=this._solar,i=this._battery,o=this._grid,r=this._load,s=this._config.solar.export_entity?this._solarExport:void 0,a=this._config.battery.grid_charge_entity?this._gridToBattery:void 0,{solarToHome:e>0?Math.min(e,r):0,solarToBattery:i>0&&e>0?Math.min(i,e):0,solarToGrid:void 0!==s?Math.max(0,s):o<0?Math.abs(o):0,gridToHome:o>0?o:0,batteryToHome:i<0?Math.abs(i):0,gridToBattery:void 0!==a?Math.max(0,a):0});const h=Date.now();!1!==this._config.show_sparklines&&h-this._lastSparklineFetch>this._sparklineDebounceMs&&(this._lastSparklineFetch=h,this._fetchSparklines())}catch(t){this._error=t.message}}_readEntity(t){var e;if(!(null===(e=this._hass)||void 0===e?void 0:e.states))return 0;const i=this._hass.states[t];return i?_t(i.state):0}async _fetchSparklines(){var t;if(!this._config||!(null===(t=this._hass)||void 0===t?void 0:t.callApi))return;const e=[this._config.solar.entity,this._config.battery.entity,this._config.grid.entity,this._config.load.entity],i=new Date,o=new Date(i.getTime()-72e5).toISOString(),r={};await Promise.allSettled(e.map(async t=>{try{const e=`history/period/${o}?filter_entity_id=${t}&minimal_response=true&no_attributes=true`,i=await this._hass.callApi("GET",e);if(!Array.isArray(i)||0===i.length)return;r[t]=i[0].map(t=>{const e=_t(t.state);return isNaN(e)?null:{time:new Date(t.last_updated).getTime(),value:e}}).filter(t=>null!==t)}catch{}})),this._sparklines={...this._sparklines,...r}}_threshold(){var t,e;return null!==(e=null===(t=this._config)||void 0===t?void 0:t.watt_threshold)&&void 0!==e?e:1e3}_deviceItems(){var t,e;return(null===(t=this._config)||void 0===t?void 0:t.devices)&&(null===(e=this._hass)||void 0===e?void 0:e.states)?this._config.devices.map(t=>{var e,i;return{entityId:t.entity,name:null!==(e=t.name)&&void 0!==e?e:t.entity,icon:null!==(i=t.icon)&&void 0!==i?i:"M7,2V13H10V22L17,10H13L17,2H7Z",watts:this._readEntity(t.entity),color:t.color}}):[]}_panelProps(t,e,i,o,r,s){var a,n,l;const d=this._threshold(),h=this._config[t];return{entityId:s,name:null!==(a=null==h?void 0:h.name)&&void 0!==a?a:i,icon:o,value:e,displayValue:vt(e,d),stateLabel:mt(s,e),stateColor:r,showSparkline:!1!==(null===(n=this._config)||void 0===n?void 0:n.show_sparklines),sparklineHistory:null!==(l=this._sparklines[s])&&void 0!==l?l:[],panelClass:`panel--${t}`,badgeClass:`badge--${t}`}}render(){var t;if(!this._config)return G`<ha-card><div class="error-card">solar-overview-card: no config.</div></ha-card>`;if(this._error)return G`<ha-card><div class="error-card">Error: ${this._error}</div></ha-card>`;const e=this._threshold(),i=!1!==this._config.show_flow,o=!1!==this._config.show_stats,r=!1!==this._config.show_devices,s=this._panelProps("solar",this._solar,"Solar","M4,2H20A2,2 0 0,1 22,4V20A2,2 0 0,1 20,22H4A2,2 0 0,1 2,20V4A2,2 0 0,1 4,2M4,4V20H20V4H4M5,5H11V11H5V5M13,5H19V11H13V5M5,13H11V19H5V13M13,13H19V19H13V13Z","#f59e0b",this._config.solar.entity),a=this._panelProps("battery",this._battery,"Battery","M16,20H8V6H16M16.67,4H15V2H9V4H7.33A1.33,1.33 0 0,0 6,5.33V20.67C6,21.4 6.6,22 7.33,22H16.67A1.33,1.33 0 0,0 18,20.67V5.33C18,4.6 17.4,4 16.67,4Z","#10b981",this._config.battery.entity),n=this._panelProps("grid",this._grid,"Grid","M11.5,3.5L10.5,6H13.5L12.5,3.5H11.5M10,7L8.5,10H15.5L14,7H10M8,11L5,17H8L9,14H15L16,17H19L16,11H8M8,18L11,21H13L16,18H8Z","#8b5cf6",this._config.grid.entity),l=this._panelProps("load",this._load,"Home","M10,20V14H14V20H19V12H22L12,3L2,12H5V20H10Z","#3b82f6",this._config.load.entity),d=this._deviceItems();return G`
      <ha-card>
        <div class="card" theme="${null!==(t=this._config.theme)&&void 0!==t?t:"auto"}">
          ...
          ${r&&this._config.devices&&this._config.devices.length>0?G`
    ...
    `}updated(t){super.updated(t)}};Vt.styles=[yt,a`:host { display: block; } ha-card { overflow: hidden; }`],t([ft()],Vt.prototype,"_config",void 0),t([ft()],Vt.prototype,"_solar",void 0),t([ft()],Vt.prototype,"_battery",void 0),t([ft()],Vt.prototype,"_grid",void 0),t([ft()],Vt.prototype,"_load",void 0),t([ft()],Vt.prototype,"_soc",void 0),t([ft()],Vt.prototype,"_solarExport",void 0),t([ft()],Vt.prototype,"_gridToBattery",void 0),t([ft()],Vt.prototype,"_flows",void 0),t([ft()],Vt.prototype,"_sparklines",void 0),t([ft()],Vt.prototype,"_error",void 0),Vt=t([ct("solar-overview-card")],Vt);let Lt=class extends dt{setConfig(t){this._config=t}_valueChanged(t){var e,i,o;if(!this._config)return;const r=t.target;if(!r.configValue)return;const s=r.configValue.split("."),a=JSON.parse(JSON.stringify(this._config)),n=a;if(2===s.length){const[t,o]=s,a=null!==(e=n[t])&&void 0!==e?e:{};a[o]=null!==(i=r.value)&&void 0!==i?i:"",n[t]=a}else n[s[0]]=null!==(o=r.value)&&void 0!==o?o:"";this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a}}))}_entityPicker(t,e,i){return G`
      <ha-entity-picker
        .hass="${this.hass}"
        .label="${t}"
        .value="${i}"
    ...
    `}_toggle(t,e,i){return G`
      <ha-formfield label="${t}">
        <ha-switch
          .checked="${i}"
          @change="${t=>{const i=t.target;if(!this._config)return;const o={...this._config,[e]:i.checked};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o}}))}}"
        ></ha-switch>
      </ha-formfield>
    `}render(){var t,e,i,o,r,s,a,n,l,d,h,c,p,g,u,f,y,v;if(!this._config)return G``;const _=this._config;return G`
      <div class="row">
        ...
        ${this._entityPicker("Grid charging battery","battery.grid_charge_entity",null!==(g=null===(p=_.battery)||void 0===p?void 0:p.grid_charge_entity)&&void 0!==g?g:"")}

        <div class="section-title">Sign conventions</div>
        ${this._toggle("Invert battery (positive = discharging)","battery",null!==(f=null===(u=_.battery)||void 0===u?void 0:u.invert)&&void 0!==f&&f)}
        ${this._toggle("Invert grid (positive = exporting)","grid",null!==(v=null===(y=_.grid)||void 0===y?void 0:y.invert)&&void 0!==v&&v)}
